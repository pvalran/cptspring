...
import com.Xoot.CreditoParaTi.entity.pima.PimaUsuarioCategory;
...
public class Employee  implements Serializable {
    ...
    private List<PimaUsuarioCategory> categoryUser;
    ...
    public List<PimaUsuarioCategory> getCategoryUser() {
        return categoryUser;
    }

    public void setCategoryUser(List<PimaUsuarioCategory> categoryUser) {
