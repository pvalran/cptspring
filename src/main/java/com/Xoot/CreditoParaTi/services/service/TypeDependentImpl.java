...
import com.Xoot.CreditoParaTi.repositories.app.ITypeDependentDao;
import com.Xoot.CreditoParaTi.repositories.app.ITypeReferenceDao;
...
public class TypeDependentImpl implements ITypeDependentService {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<TypeDependent> findByCivil(Integer id) { return _typeDependentDao.findByCivil(id);  }
